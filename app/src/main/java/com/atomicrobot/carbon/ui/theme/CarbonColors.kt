...
class CarbonColors(){
    companion object {
        ...
        val Pink700: Color = Color(0xFFFF4081)
        val Neutron: Color = Color(0xFF101C1D)
        val Orange: Color = Color(0xFFE25C33)
        val LightGray: Color = Color(0xFFEEEEEE)
        val MediumGray: Color = Color(0xFFE0E0E0)
        val FullGray: Color = Color(0xFF888888)
        val Mono800: Color = Color(0xFF222C2D)
